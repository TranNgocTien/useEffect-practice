    ...
    function () {
      ...
      async function fetchMovies() {
        try {
          ...
          if (!res.ok)
            throw new Error("Something went wrong withb fetching movies!");
...
function MovieDetails({ selectedId, onCloseMovie, onAddWatch, watched }) {
  ...
  const isInList = watched.map((movie) => movie.imdbID).include(selectedId);
...
function MoviesItem({ movie, onSelectMovie }) {
  return (
